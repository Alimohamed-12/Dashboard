  ...
  return (
    <div className="min-h-screen bg-koda-bg">
      <main className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={fetchOrders}
              className="w-10 h-10 rounded-lg border border-koda-border/50 bg-white flex items-center justify-center hover:bg-slate-50"
              title="تحديث"
            >
            ...
            <div className="bg-white border border-koda-border/50 rounded-xl2 shadow-soft px-5 py-3 text-center">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-5">
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-koda-border/50 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-koda-teal/40 focus:border-koda-teal"
            />
          </div>
        ...
        <div className="bg-koda-card border border-koda-border/50 rounded-xl2 shadow-soft overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-[11px] tracking-wider text-koda-muted font-bold uppercase border-b border-koda-border/50">
              ...
              <tbody>
                ...
                {!loading &&
                  ...
                  filtered.map((order) => (
                    <tr
                      key={order.id}
                      className="border-b border-koda-border/50 last:border-0 hover:bg-slate-50/60 cursor-pointer"
