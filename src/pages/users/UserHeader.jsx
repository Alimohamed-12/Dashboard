...
function UserHeader() {
    return(
        ...
        <button className="bg-[#0ea5e9] hover:bg-[#0284c7] text-white px-5 py-3 rounded-xl flex items-center gap-2 text-sm font-semibold transition-colors whitespace-nowrap">
          <Plus size={18} />
          Add User
        </button>
      </div>
