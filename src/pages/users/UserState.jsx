  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex justify-between items-center">
        ...
        <div className="bg-[#0ea5e9] p-3 rounded-xl text-white"><UsersIcon size={24} /></div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex justify-between items-center">
        ...
        <div className="bg-[#0ea5e9] p-3 rounded-xl text-white"><Shield size={24} /></div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex justify-between items-center">
        ...
        <div className="bg-[#0ea5e9] p-3 rounded-xl text-white"><UserCheck size={24} /></div>
      </div>
    </div>
  );
}
