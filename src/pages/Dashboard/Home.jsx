import React, { useState, useEffect } from 'react';import Cards from './cards';
...
useEffect(() => {
  ...
  return (
    ...
    <div className='bg-white rounded-2xl p-8 mt-8 mb-8 shadow-md'>
      <h2 className='text-cyan-400 text-sm  tracking-[5px] uppercase '>Admin overview</h2>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
      <Cards title="Total Orders" 
             ...
             Icon={ShoppingBag} 
             borderColor="border-[#2dd4bf]" iconBgColor="bg-[#ccfbf1]" iconColor="text-[#0d9488]"></Cards>
  ...
  <Cards 
    title="Top Product" 
    value={stats?.dashboard?.topSellingProducts?.[0]?.name || "iPhone 15 Pro Max"} 
    subtitle={`${stats?.dashboard?.topSellingProducts?.[0]?.soldCount || 6} sold`} 
    Icon={Package} 
  ...
  <Cards 
    title="Users" 
    value={stats?.dashboard?.totalCustomers || stats?.dashboard?.usersCount || 0} 
